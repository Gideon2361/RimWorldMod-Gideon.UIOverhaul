...
namespace Gideon.UIOverhaul.Features.History
{
    ...
    internal static class HistoryFaces
    {
        ...
        /// <summary>
        /// This tab's color: a muted emerald, defaulting to <c>#72C093</c>.
        ///
        /// <b>It never draws inside the axes.</b> The chart series own the plot; this draws only on the chrome
        /// around it. See <see cref="UIColorRole.TabHistory"/> for why this tab can hold the green the research
        /// tab had to refuse.
        /// </summary>
        internal static Color AccentOf(UIColorPaletteDef palette)
        {
            return palette == null ? new Color(0.447f, 0.753f, 0.576f) : palette.TabHistory;
        }
